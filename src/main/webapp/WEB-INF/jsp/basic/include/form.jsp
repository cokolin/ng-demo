<%@ page language="java" pageEncoding="UTF-8"%><%@include file="/WEB-INF/tags/tags.jsp"%><c:if test="${module.form ne null}">
	<form class="${module.form.type.value} ${module.form.clas}" name="${module.form.name}" data-ng-submit="${module.form.submit}">
								...
								<c:if test="${col.ipts ne null}">
									<c:forEach items="${col.ipts}" var="ipt">
										<c:choose>
											...
											<c:when test="${ipt.type eq 'NUMBER'}">
												<div class="${ipt.clas}" title="${ipt.title}">
											...
											<c:when test="${ipt.type eq 'MONTHLY'}">
												<div class="${ipt.clas}" title="${ipt.title}">
											...
											<c:when test="${ipt.type eq 'DATETIME'}">
												<div class="${ipt.clas}" title="${ipt.title}">
											...
											<c:when test="${ipt.type eq 'SELECT'}">
												<div class="${ipt.clas}" title="${ipt.title}">
											...
											<c:when test="${ipt.type eq 'TEXTAREA'}">
												<div class="${ipt.clas}" title="${ipt.title}">
											...
											<c:when test="${ipt.type eq 'CHECKBOX'}">
											...
											<c:when test="${ipt.type eq 'CHECKALL'}">
											...
											<c:when test="${ipt.type eq 'RADIOALL'}">
